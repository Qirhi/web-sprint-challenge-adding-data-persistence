...
[x] 1. `index.js`
[x] 2. `api/server.js`
[x] 3. `model.js` inside `api/project`, `api/resource` and `api/task`
[x] 4. `router.js` inside `api/project`, `api/resource` and `api/task`
[x] 5. migration file(s)
[x] 6. seed file(s) **optional**
